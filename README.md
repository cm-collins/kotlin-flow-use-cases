...
1. Open any `.kt` file in the `flow_basics`, `stateflow_use_cases`, or `sharedflow` directories.
...
- **SharedFlow**: Hot flows for one-time Events and Broadcasting.
...
3.  **[SharedFlow](./kotlinflows/src/main/kotlin/com/example/kotlinflows/sharedflow/README.md)**: Master Hot Flows for one-time Events and side effects.
4.  **Intermediate Operators**: (Coming Soon) Learn how to transform and combine data.
...
│       ├── sharedflow/      # 🔔 Event Handling & Broadcasting
